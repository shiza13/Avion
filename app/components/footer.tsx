...
<footer className="bg-[#262153] text-white py-8">
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <ul className="space-y-2 text-sm text-gray-400">
        <li><Link href="/components/crockery" className="hover:underline">Crockery</Link></li>
        <li><Link href="/components/furniture" className="hover:underline">Furniture</Link></li>
        <li><Link href="/components/homeware" className="hover:underline">Homeware</Link></li>
        <li><Link href="/components/plantpots" className="hover:underline">Plant pots</Link></li>
        <li><Link href="/components/chairs" className="hover:underline">Chairs</Link></li>
      </ul>
    </div>
